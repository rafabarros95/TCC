<?php 
    ...
    $sql = "UPDATE registration SET reset_token_hash = ?, reset_token_expires_at = ? WHERE email = ?";
    ...
    if($mysqli->affected_rows) {
       ...
       Click <a href="http://localhost/TCC/TCC/reset-password.php?token=$token">here</a> to reset your password.
